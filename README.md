...
### 1. Home Page
![Home Page](https://via.placeholder.com/1024x576/0D1B3E/FFFFFF.png?text=Home+Page+-+Add+Screenshot+Here)
...
![Mega Search Bar](https://via.placeholder.com/1024x250/0D1B3E/FFFFFF.png?text=Mega+Search+Bar+-+Add+Screenshot+Here)
*A modern, adaptive search component that smoothly transitions from a single pill on desktop to stacked elements on mobile.*

### 3. Listings Page
![Listings Page](https://via.placeholder.com/1024x576/0D1B3E/FFFFFF.png?text=Listings+Page+-+Add+Screenshot+Here)
*Browse and filter thousands of verified cars with price, body type, make, and custom tag filters.*

### 4. Car Details & 3D Showcase
![Car Details](https://via.placeholder.com/1024x576/0D1B3E/FFFFFF.png?text=Car+Details+-+Add+Screenshot+Here)
*Detailed view of a vehicle, including HD images, performance statistics, and seller information.*

### 5. Compare Vehicles
![Compare Vehicles](https://via.placeholder.com/1024x576/0D1B3E/FFFFFF.png?text=Compare+Vehicles+-+Add+Screenshot+Here)
*Side-by-side technical specification comparison of multiple vehicles.*

### 6. AI Finder
![AI Finder](https://via.placeholder.com/1024x576/0D1B3E/FFFFFF.png?text=AI+Finder+-+Add+Screenshot+Here)
*Get personalized car recommendations generated by OpenAI based on user budget and priorities.*

### 7. Post a Listing (Sell Page)
![Post Listing](https://via.placeholder.com/1024x576/0D1B3E/FFFFFF.png?text=Post+Listing+-+Add+Screenshot+Here)
